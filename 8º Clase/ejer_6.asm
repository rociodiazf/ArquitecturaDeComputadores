...
#-- la conversion a entero. Debe implementar tmb aceptacion a los numeros negativos
...
msg_2:  .string "\n El numero resultante es:"
	...
	la t1, cad	#-- Apuntamos cad
	li s0, 1	#-- Nos guardaremos este registro para el cambio de signo
	lb t2, 0(t1)	#-- Leemos el primer caracter
	li t3, '-'
	bne t2, t3, calcula_numero
	#-- En caso de que si sean iguales
	li s0, -1
	addi t1, t1, 1
...
calcula_numero:
	...
	li t3 '\n'	#-- Inicializamos el salto de linea
